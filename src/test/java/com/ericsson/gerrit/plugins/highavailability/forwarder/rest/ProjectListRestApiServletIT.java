...
public class ProjectListRestApiServletIT extends LightweightPluginDaemonTest {
  ...
  public void addProject() throws Exception {
    ...
    adminRestSession.post("/plugins/high-availability/cache/project_list/" + newProject.get()).assertNoContent();
  ...
  public void removeProject() throws Exception {
    ...
    adminRestSession.delete("/plugins/high-availability/cache/project_list/" + project.get()).assertNoContent();
