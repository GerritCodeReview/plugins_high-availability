...
public class ForwardedChangeIndexingHandlerTest {
  ...
  private ForwardedChangeIndexingHandler handler;
  ...
  public void setUp() throws Exception {
    ...
    id = Change.Id.parse("123");
    change = new Change(null, id, null, null, TimeUtil.nowTs());
    handler = new ForwardedChangeIndexingHandler(indexerMock, schemaFactoryMock);
  }
  ...
  private void setupChangeAccessRelatedMocks(
      boolean changeExist, boolean ormException, boolean ioException)
      throws OrmException, IOException {
    if (ormException) {
