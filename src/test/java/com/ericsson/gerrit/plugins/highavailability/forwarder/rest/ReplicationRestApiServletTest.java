...
public class ReplicationRestApiServletTest {
  ...
  private ReplicationRestApiServlet replicationtRestApiServlet;
  ...
  @Test
  public void testDoPostReplication() throws Exception {
    String event =
        "{\"project\":\"gerrit/some-project\",\"ref\":"
            + "\"refs/changes/76/669676/2\",\"nodesCount\":1,\"class\":"
            + "\"com.ericsson.gerrit.plugins.highavailability.replication.events.ForwardedGitReferenceUpdatedEvent\",\"eventCreatedOn\":1451415011}";
    when(requestMock.getRequestURI())
        .thenReturn(Url.encode(ForwardedGitReferenceUpdatedEvent.class.getCanonicalName()));
