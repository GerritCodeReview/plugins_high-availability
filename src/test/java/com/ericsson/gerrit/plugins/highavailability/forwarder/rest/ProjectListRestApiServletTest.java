...
public class ProjectListRestApiServletTest {
  private static final String PROEJCT_NAME = "someProject";
  ...
  public void setUpMocks() {
    ...
    when(requestMock.getPathInfo()).thenReturn("/cache/project_list/" + PROEJCT_NAME);
  }

  @Test
  public void addProject() throws Exception {
    servlet.doPost(requestMock, responseMock);
    verify(handlerMock, times(1)).update(PROEJCT_NAME, false);
  ...
  public void deleteProject() throws Exception {
    ...
    verify(handlerMock, times(1)).update(PROEJCT_NAME, true);
    verify(responseMock).setStatus(SC_NO_CONTENT);
  }
}
