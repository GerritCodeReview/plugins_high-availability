...
public class CacheRestApiServletTest {
  ...
  public void evictAccounts() throws Exception {
    configureMocksFor(Contants.ACCOUNTS);
    verifyResponseIsOK();
  }

  @Test
  public void evictProjectList() throws Exception {
    configureMocksFor(Contants.PROJECT_LIST);
    verifyResponseIsOK();
  }

  @Test
  public void evictGroups() throws Exception {
    configureMocksFor(Contants.GROUPS);
    verifyResponseIsOK();
  }

  @Test
  public void evictGroupsByInclude() throws Exception {
    configureMocksFor(Contants.GROUPS_BYINCLUDE);
    verifyResponseIsOK();
  }

  @Test
  public void evictGroupsMembers() throws Exception {
    configureMocksFor(Contants.GROUPS_MEMBERS);
  ...
  public void evictDefault() throws Exception {
    configureMocksFor(Contants.PROJECTS);
    verifyResponseIsOK();
  }
  ...
  private void configureMocksFor(String cacheName) throws IOException {
    ...
    if (Contants.PROJECTS.equals(cacheName)) {
      when(reader.readLine()).thenReturn("abc");
    } else if (Contants.GROUPS_BYINCLUDE.equals(cacheName)
        || Contants.GROUPS_MEMBERS.equals(cacheName)) {
