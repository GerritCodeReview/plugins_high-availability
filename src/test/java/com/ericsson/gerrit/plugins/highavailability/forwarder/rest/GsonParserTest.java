...
public class GsonParserTest {
  ...
  public void AccountIDParse() {
    ...
    assertThat(accountId)
        .isEqualTo(GsonParser.fromJson(CacheContants.ACCOUNTS, json));
  }
  ...
  public void AccountGroupIDParse() {
    ...
    assertThat(accountGroupId)
        .isEqualTo(GsonParser.fromJson(CacheContants.GROUPS, json));
  }
  ...
  public void AccountGroupUUIDParse() {
    ...
    String json =
        GsonParser.toJson(CacheContants.GROUPS_BYINCLUDE, accountGroupUuid);
    assertThat(accountGroupUuid).isEqualTo(
        GsonParser.fromJson(CacheContants.GROUPS_BYINCLUDE, json));
  }
  ...
  public void StringParse() {
    ...
    assertThat(key)
        .isEqualTo(GsonParser.fromJson(CacheContants.PROJECTS, json));
  }
