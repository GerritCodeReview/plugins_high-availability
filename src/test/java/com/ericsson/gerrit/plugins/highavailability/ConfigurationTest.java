...
public class ConfigurationTest {
  ...
  public void testGetJGroupsMyUrlOverridesListenUrl() throws Exception {
    ...
    assertThat(getPeerInfoProvider().myUrl()).isEqualTo(URL);
  }
  ...
  public void testGetJGroupsMyUrlFromListenUrl() throws Exception {
    ...
    String expected = "https://" + InetAddress.getLocalHost().getHostName() + ":8080";
    assertThat(getPeerInfoProvider().myUrl()).isEqualTo(expected);
  }

  private JGroupsPeerInfoProvider getPeerInfoProvider() {
    // In the current scope of JGroupsPeerInfoProvider tests, no instance
    // of InetAddressFinder is needed.
    InetAddressFinder finder = null;
    return new JGroupsPeerInfoProvider(serverConfigMock, configuration, finder);
  }
