...
public class ConfigurationTest {
  ...
  public void testGetUrl() {
    ...
    when(configMock.getString(HTTP_SECTION, null, URL_KEY)).thenReturn(URL);
    initializeConfiguration();
    assertThat(configuration.getUrl()).isEqualTo(URL);
  }

  @Test
  public void testGetUrlIsDroppingTrailingSlash() {
    when(configMock.getString(HTTP_SECTION, null, "url")).thenReturn(URL + "/");
    initializeConfiguration();
  ...
  public void testGetIndexThreadPoolSize() {
    ...
    when(configMock.getInt(INDEX_SECTION, INDEX_THREAD_POOL_SIZE_KEY, DEFAULT_THREAD_POOL_SIZE))
  ...
  public void testGetCacheThreadPoolSize() {
    ...
    when(configMock.getInt(CACHE_SECTION, CACHE_THREAD_POOL_SIZE_KEY, DEFAULT_THREAD_POOL_SIZE))
        .thenReturn(THREAD_POOL_SIZE);
    initializeConfiguration();
  ...
  @Test
  public void testGetSharedDirectory() {
    initializeConfiguration();
  ...
  @Test
  public void testGetCleanupInterval() {
    initializeConfiguration();
