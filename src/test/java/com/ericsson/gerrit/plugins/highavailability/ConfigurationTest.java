...
public class ConfigurationTest {
  ...
  public void testConfiguredListenerShouldBeAllowed() throws Exception {
    ...
    assertThat(new ConfigurableAllowEventListeners(getConfiguration()).isAllowed(listener))
        .isFalse();

    globalPluginConfig.setStringList(
        EVENT_SECTION, null, ALLOWED_LISTENERS, Arrays.asList(listener.getClass().getName()));
