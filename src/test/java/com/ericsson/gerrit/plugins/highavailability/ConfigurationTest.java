...
public class ConfigurationTest {
  private static String PLUGIN_NAME = "high-availability";
  ...
  public void testGetJGroupsSkipInterface() throws Exception {
    ...
    globalPluginConfig.setStringList(
        JGROUPS_SECTION, null, SKIP_INTERFACE_KEY, Lists.newArrayList("lo*", "eth0"));
  ...
  public void testGetCachePatterns() throws Exception {
    globalPluginConfig.setStringList(
        CACHE_SECTION, null, PATTERN_KEY, Lists.newArrayList("^my_cache.*", "other"));
