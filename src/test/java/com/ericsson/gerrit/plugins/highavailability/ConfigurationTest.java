...
import static com.ericsson.gerrit.plugins.highavailability.Configuration.ENABLE;
...
public class ConfigurationTest {
  ...
  public void testHealthCheckEnabled() throws Exception {
    when(configMock.getBoolean(HEALTH_CHECK_SECTION, ENABLE, DEFAULT_HEALTH_CHECK_ENABLED))
        .thenReturn(false);
    initializeConfiguration();
