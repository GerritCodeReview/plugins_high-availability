...
public class RestForwarderTest {
  ...
  private Provider<Set<PeerInfo>> peersMock;
  ...
  public void setUp() {
    ...
    forwarder = new RestForwarder(httpSessionMock, PLUGIN_NAME, configMock, peersMock); // TODO: Create provider
  }
  ...
  public void testEvictGroupsOK() throws Exception {
    ...
    when(httpSessionMock.post(endpoint, keyJson))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
