...
import com.ericsson.gerrit.plugins.highavailability.cache.CacheContants;
...
public class RestForwarderTest {
  ...
  public void testEvictCacheOK() throws Exception {
    setupMocksForCache(CacheContants.PROJECTS, EMPTY_JSON2, SUCCESSFUL,
        DO_NOT_THROW_EXCEPTION);
    assertThat(restForwarder.evict(CacheContants.PROJECTS, EMPTY_JSON))
        .isTrue();
  }

  @Test
  public void testEvictAccountsOK() throws Exception {
    setupMocksForCache(CacheContants.ACCOUNTS, ID_JSON, SUCCESSFUL,
        DO_NOT_THROW_EXCEPTION);
    assertThat(
        restForwarder.evict(CacheContants.ACCOUNTS, mock(Account.Id.class)))
            .isTrue();
  }

  @Test
  public void testEvictGroupsOK() throws Exception {
    setupMocksForCache(CacheContants.GROUPS, ID_JSON, SUCCESSFUL,
        DO_NOT_THROW_EXCEPTION);
    assertThat(restForwarder.evict(CacheContants.GROUPS,
        mock(AccountGroup.Id.class))).isTrue();
  }

  @Test
  public void testEvictGroupsByIncludeOK() throws Exception {
    setupMocksForCache(CacheContants.GROUPS_BYINCLUDE, EMPTY_JSON,
        SUCCESSFUL, DO_NOT_THROW_EXCEPTION);
    assertThat(restForwarder.evict(CacheContants.GROUPS_BYINCLUDE,
        mock(AccountGroup.UUID.class))).isTrue();
  }

  @Test
  public void testEvictGroupsMembersOK() throws Exception {
    setupMocksForCache(CacheContants.GROUPS_MEMBERS, EMPTY_JSON, SUCCESSFUL,
        DO_NOT_THROW_EXCEPTION);
    assertThat(restForwarder.evict(CacheContants.GROUPS_MEMBERS,
        mock(AccountGroup.UUID.class))).isTrue();
  }

  @Test
  public void testEvictProjectListOK() throws Exception {
    setupMocksForCache(CacheContants.PROJECT_LIST, EMPTY_JSON, SUCCESSFUL,
        DO_NOT_THROW_EXCEPTION);
    assertThat(
        restForwarder.evict(CacheContants.PROJECT_LIST, new Object()))
            .isTrue();
  }

  @Test
  public void testEvictCacheFailed() throws Exception {
    setupMocksForCache(CacheContants.PROJECTS, EMPTY_JSON2, FAILED,
        DO_NOT_THROW_EXCEPTION);
    assertThat(restForwarder.evict(CacheContants.PROJECTS, EMPTY_JSON))
        .isFalse();
  }
