...
public class RestForwarderTest {
  ...
  public void testIndexAccountOK() throws Exception {
    when(httpSessionMock.post(eq(INDEX_ACCOUNT_ENDPOINT), any(), anyLong()))
  ...
  public void testIndexGroupOK() throws Exception {
    when(httpSessionMock.post(eq(INDEX_GROUP_ENDPOINT), any(), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testIndexChangeOK() throws Exception {
    when(httpSessionMock.post(eq(INDEX_CHANGE_ENDPOINT), any(), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
    assertThat(
            forwarder
  ...
  public void testIndexBatchChangeOK() throws Exception {
    when(httpSessionMock.post(eq(INDEX_BATCH_CHANGE_ENDPOINT), any(), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testChangeDeletedFromIndexOK() throws Exception {
    when(httpSessionMock.delete(eq(DELETE_CHANGE_ENDPOINT), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
    assertThat(
            forwarder
  ...
  public void testAllChangesDeletedFromIndexOK() throws Exception {
    when(httpSessionMock.delete(eq(DELETE_ALL_CHANGES_ENDPOINT), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
    assertThat(
            forwarder
  ...
  public void testEventSentOK() throws Exception {
    when(httpSessionMock.post(eq(EVENT_ENDPOINT), eq(event), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testEvictProjectOK() throws Exception {
    ...
    when(httpSessionMock.post(eq(buildCacheEndpoint(Constants.PROJECTS)), eq(keyJson), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testEvictAccountsOK() throws Exception {
    ...
    String keyJson = gson.toJson(key);
    when(httpSessionMock.post(eq(buildCacheEndpoint(Constants.ACCOUNTS)), eq(keyJson), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testEvictGroupsOK() throws Exception {
    ...
    when(httpSessionMock.post(eq(endpoint), eq(keyJson), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testEvictGroupsByIncludeOK() throws Exception {
    ...
    when(httpSessionMock.post(
            eq(buildCacheEndpoint(Constants.GROUPS_BYINCLUDE)), eq(keyJson), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
    assertThat(
  ...
  public void testEvictGroupsMembersOK() throws Exception {
    ...
    String keyJson = gson.toJson(key);
    when(httpSessionMock.post(
            eq(buildCacheEndpoint(Constants.GROUPS_MEMBERS)), eq(keyJson), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testAddToProjectListOK() throws Exception {
    ...
    when(httpSessionMock.post(eq(buildProjectListCacheEndpoint(projectName)), any(), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testRemoveFromProjectListOK() throws Exception {
    ...
    when(httpSessionMock.delete(eq(buildProjectListCacheEndpoint(projectName)), anyLong()))
        .thenReturn(new HttpResult(SUCCESSFUL, EMPTY_MSG));
  ...
  public void testRetryOnErrorThenSuccess() throws Exception {
    when(httpSessionMock.post(anyString(), anyString(), anyLong()))
