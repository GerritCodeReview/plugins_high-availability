...
package com.googlesource.gerrit.plugins.highavailability;

import static com.googlesource.gerrit.plugins.highavailability.Configuration.CACHE_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.CLEANUP_INTERVAL_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.CLUSTER_NAME_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.CONNECTION_TIMEOUT_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_CLEANUP_INTERVAL_MS;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_CLUSTER_NAME;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_HEALTH_CHECK_ENABLED;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_MAX_TRIES;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_PEER_INFO_STRATEGY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_RETRY_INTERVAL;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_SHARED_DIRECTORY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_SKIP_INTERFACE_LIST;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_SYNCHRONIZE;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_THREAD_POOL_SIZE;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.DEFAULT_TIMEOUT_MS;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.ENABLE_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.EVENT_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.HEALTH_CHECK_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.HTTP_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.INDEX_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.JGROUPS_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.JGROUPS_SUBSECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.MAIN_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.MAX_TRIES_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.MY_URL_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.PASSWORD_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.PATTERN_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.PEER_INFO_SECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.PROTOCOL_STACK_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.RETRY_INTERVAL_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.SHARED_DIRECTORY_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.SKIP_INTERFACE_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.SOCKET_TIMEOUT_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.STATIC_SUBSECTION;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.STRATEGY_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.SYNCHRONIZE_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.THREAD_POOL_SIZE_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.URL_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.USER_KEY;
import static com.googlesource.gerrit.plugins.highavailability.Configuration.WEBSESSION_SECTION;
...
import com.googlesource.gerrit.plugins.highavailability.Configuration.PeerInfoStrategy;
