...
import com.ericsson.gerrit.plugins.highavailability.forwarder.ForwardedAccountIndexingHandler;
...
class IndexAccountRestApiServlet extends AbstractIndexRestApiServlet<Account.Id> {
  ...
  @Inject
  IndexAccountRestApiServlet(ForwardedAccountIndexingHandler handler) {
