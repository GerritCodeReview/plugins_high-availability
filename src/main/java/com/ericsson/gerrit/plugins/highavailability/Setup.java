...
public class Setup implements InitStep {
  ...
  private String promptAndSetString(
    ...
    return configUtil.promptAndSetString(config, title, section, name, defaultValue);
  }

  private String promptAndSetString(
      String title, String section, String subsection, String name, String defaultValue) {
    return configUtil.promptAndSetString(config, title, section, subsection, name, defaultValue);
  }
