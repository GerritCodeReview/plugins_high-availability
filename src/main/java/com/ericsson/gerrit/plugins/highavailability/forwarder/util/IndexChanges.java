...
public class IndexChanges {
  private static final Logger log = LoggerFactory.getLogger(IndexChanges.class);
  ...
  @Inject
  public IndexChanges(ChangeIndexer indexer, SchemaFactory<ReviewDb> schemaFactory) {
    this.indexer = indexer;
    this.schemaFactory = schemaFactory;
  }

  public void index(Change.Id id, Operation op) throws IOException, OrmException {
