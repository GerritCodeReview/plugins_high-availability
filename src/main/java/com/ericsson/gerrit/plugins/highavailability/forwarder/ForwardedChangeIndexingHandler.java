 ...
 */
@Singleton
public class ForwardedChangeIndexingHandler extends ForwardedIndexingHandler<Change.Id> {
  private final ChangeIndexer indexer;
  private final SchemaFactory<ReviewDb> schemaFactory;

  @Inject
  ForwardedChangeIndexingHandler(ChangeIndexer indexer, SchemaFactory<ReviewDb> schemaFactory) {
