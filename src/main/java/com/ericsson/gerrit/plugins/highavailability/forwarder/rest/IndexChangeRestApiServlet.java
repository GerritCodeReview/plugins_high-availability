...
import com.ericsson.gerrit.plugins.highavailability.forwarder.ForwardedChangeIndexingHandler;
...
class IndexChangeRestApiServlet extends AbstractIndexRestApiServlet<Change.Id> {
  ...
  IndexChangeRestApiServlet(
      ForwardedChangeIndexingHandler handler, SchemaFactory<ReviewDb> schemaFactory) {
