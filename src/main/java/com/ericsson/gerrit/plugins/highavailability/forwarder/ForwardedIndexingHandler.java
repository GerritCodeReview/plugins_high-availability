...
public abstract class ForwardedIndexingHandler<T> {
  ...
  /**
   * Index a change in the local node, indexing will not be forwarded to the other node.
   *
   * @param id The id to index.
   * @param operation The indexing operation to do; index or delete
   * @throws IOException If an error occur while indexing.
   * @throws OrmException If an error occur while retrieving a change
   */
  public final void index(T id, IndexingOperation operation) throws IOException, OrmException {
