...
public class Configuration {
  ...
  // autoReindex section
  static final String AUTO_REINDEX = "autoReindex";
  ...
  public static class AutoReindex {
    ...
    public AutoReindex(Config cfg) {
      this.enabled = cfg.getBoolean(AUTO_REINDEX, ENABLED, false);
      this.delaySec = ConfigUtil.getTimeUnit(cfg, AUTO_REINDEX, null, DELAY, 10L, TimeUnit.SECONDS);
      this.pollSec =
          ConfigUtil.getTimeUnit(cfg, AUTO_REINDEX, null, POLL_INTERVAL, 0L, TimeUnit.SECONDS);
    }
