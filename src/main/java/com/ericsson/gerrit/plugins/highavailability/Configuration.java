...
public class Configuration {
  ...
  private static String getString(Config cfg, String section, String subSectionName, String name,
      String defaultValue) {
    try {
  ...
  public static class PeerInfo {
    ...
    private PeerInfo(Config cfg) {
      ...
      String strategyName = getString(cfg, PEER_INFO_SECTION, null, STRATEGY_KEY,
          DEFAULT_PEER_INFO_STRATEGY.toString());
      try {
  ...
  public static class JGroups extends Forwarding {
    ...
    private JGroups(Config cfg) {
      ...
      skipInterfacePattern = Strings.nullToEmpty(getString(cfg, JGROUPS_SECTION, null,
          SKIP_INTERFACE_PATTERN_KEY, DEFAULT_SKIP_INTERFACE_PATTERN));
      preferIPv4 = cfg.getBoolean(JGROUPS_SECTION, null, PREFER_IPV4_KEY, DEFAULT_PREFER_IPV4);
      clusterName = Strings.nullToEmpty(
          getString(cfg, JGROUPS_SECTION, null, CLUSTER_NAME_KEY, DEFAULT_CLUSTER_NAME));
    }
