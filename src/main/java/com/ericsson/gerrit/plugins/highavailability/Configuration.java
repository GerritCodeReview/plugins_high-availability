...
public class Configuration {
  ...
  public static class Main {
    ...
    private Main(SitePaths site, Config cfg) {
      ...
      maxTries = read(cfg, MAX_TRIES_KEY, DEFAULT_MAX_TRIES);
      retryInterval = read(cfg, RETRY_INTERVAL_KEY, DEFAULT_RETRY_INTERVAL);
    }

    private static int read(Config cfg, String key, int defaultValue) {
    ...
    private static int parseInt(String key, String toParse) {
      try {
