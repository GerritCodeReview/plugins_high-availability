...
public class Configuration {
  ...
  public static class AutoReindex {
    ...
    public AutoReindex(Config cfg) {
      ...
      this.delaySec = ConfigUtil.getTimeUnit(cfg, AUTO_REINDEX_SECTION, null, DELAY, 10L, TimeUnit.SECONDS);
      this.pollSec =
          ConfigUtil.getTimeUnit(cfg, AUTO_REINDEX_SECTION, null, POLL_INTERVAL, 0L, TimeUnit.SECONDS);
    }
