...
import com.ericsson.gerrit.plugins.highavailability.forwarder.ForwardedGroupIndexingHandler;
...
class IndexGroupRestApiServlet extends AbstractIndexRestApiServlet<AccountGroup.UUID> {
  ...
  @Inject
  IndexGroupRestApiServlet(ForwardedGroupIndexingHandler handler) {
